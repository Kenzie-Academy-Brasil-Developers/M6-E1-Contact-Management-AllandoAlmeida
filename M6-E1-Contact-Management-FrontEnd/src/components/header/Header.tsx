import { CustomerContactData, CustomerData } from '@/schema/customer.schema';
import Link from 'next/link';
import Image from 'next/image';
import { SignOutIcon } from '../icons/SignOutIcon';

const Header = ({customer}: CustomerContactData) => {
  const firstLetter = customer?.name? customer.name.charAt(0) : null;
